...
const AdminAPI = {
  ...
  createSubject: async (data) => {
    const res = await axiosClient.post("/api/subjects", data);
    return res.data;
  },
  updateSubject: async (id, data) => {
    const res = await axiosClient.put(`/api/subjects/${id}`, data);
    return res.data;
  },
  deleteSubject: async (id) => {
    const res = await axiosClient.delete(`/api/subjects/${id}`);
    return res.data;
  },
