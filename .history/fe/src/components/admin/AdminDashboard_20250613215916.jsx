...
function AdminDashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="ml-64 text-2xl font-bold">Admin Dashboard</h1>
        <p className="ml-64 mt-2 text-gray-600">Tổng quan hệ thống quản lý điểm</p>
      </div>

      <div className="ml-64 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
