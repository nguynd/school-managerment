...
function ManageClassesAndStudents() {
  ...
  if (selectedClass) {
    return (
      <div className="ml-64 p-4 mt-20">
        ...
        <button onClick={handleAddStudent} className="mt-4 px-4 py-2 bg-green-600 text-white rounded">
          ➕ Thêm học sinh
        </button>
      </div>
    );
  ...
  return (
    <div className="ml-64 p-4 mt-20">
      ...
      <button onClick={handleAddClass} className="mt-4 px-4 py-2 bg-blue-600 text-white rounded">
        ➕ Thêm lớp
      </button>
    </div>
  );
