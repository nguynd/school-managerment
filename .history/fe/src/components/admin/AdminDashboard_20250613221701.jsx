...
function AdminDashboard() {
  ...
  <button
    ...
    className="w-full h-full bg-blue-600 text-white text-sm font-semibold rounded hover:bg-blue-700"
  >
    Khởi tạo kỳ học
  </button>
</div>
...
<div className="ml-68 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-stretch">
