  ...
  useEffect(() => {
    if (selectedClass) {
      ...
      const enrichWithAverages = async () => {
        console.log("🎯 subject weights debug:", {
  rw: subject.regular_weight,
  mw: subject.mid_weight,
  fw: subject.final_weight
});
        ...
        const updated = scores.map((s) => {
          const { tx1 = 0, tx2 = 0, tx3 = 0, gk = 0, ck = 0 } = s;
          const avg =
              ...
              {filteredScores.length === 0 ? (
                ...
                <>
                  ...
                  <tr className="border-t font-semibold bg-gray-50">
                    <td colSpan="7" className="p-2 text-right pr-4 italic">
                      → Trung bình lớp:
                    </td>
