        ...
        className={`cursor-pointer border rounded-xl p-4 transition-all duration-200
          ${
            isSelected
              ...
              : "bg-white text-black border-gray-300 hover:bg-blue-500 hover:text-white hover:border-blue-500 hover:shadow-md"
          }`}
      >
        <p className="font-semibold text-lg">
          {cls.class_name} - {cls.subject_name}
        </p>
        <p className="text-sm">Sĩ số: {cls.student_count}</p>
      </div>
    );
  })}
</div>
