...
const fetchStudents = async () => {
  if (viewMode === "YEAR") {
    await HomeroomAPI.generateYearlyGrades(data.class_id, year); // POST
    const res = await HomeroomAPI.getYearlyGrades(data.class_id, year); // GET
    setStudents(res);
  } else {
...
useEffect(() => {
  ...
  if (viewMode === "HK") {
    ...
    setClassAverage(null); // hoặc giữ nguyên tuỳ bạn
  }
