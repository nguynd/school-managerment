...
exports.createStudent = async (req, res) => {
 const { name, date_of_birth, class_id, gender, user_id } = req.body;
  ...
  `INSERT INTO students (name, date_of_birth, class_id, gender, user_id) 
   VALUES ($1, $2, $3, $4, $5) RETURNING *`,
  [name, date_of_birth, class_id, gender, user_id || null]
);
...
const id = req.params.id;
  ...
  try {
   const result = await pool.query(
  `UPDATE students 
   SET name = $1, date_of_birth = $2, class_id = $3, gender = $4, user_id = $5
   WHERE id = $6 RETURNING *`,
  [name, date_of_birth, class_id, gender, user_id || null, id]
);
