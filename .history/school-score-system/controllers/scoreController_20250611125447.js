...
exports.createScore = async (req, res) => {
  const { student_id, subject_id, semester, year, label, score } = req.body;
  try {
    const result = await pool.query(
      `INSERT INTO scores (student_id, subject_id, semester, year, label, score)
       VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`,
      [student_id, subject_id, semester, year, label, score]
    );
